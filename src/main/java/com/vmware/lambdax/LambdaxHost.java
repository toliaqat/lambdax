 ...
 */
public class LambdaxHost extends ServiceHost {
    /**
     ...
     */
    static LambdaxHost startHost(String[] stringArgs, Arguments args) throws Throwable {
        LambdaxHost h = new LambdaxHost();
    ...
    public ServiceHost start() throws Throwable {
        ...
        super.startFactory(new LambdaxService());
